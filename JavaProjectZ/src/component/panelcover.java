...
public class panelcover extends javax.swing.JPanel {
    ...
    private void init(){
        ...
        description.setFont(new Font("sansserif",1,30));
        description.setForeground(new Color(245,245,245));
        add(description);
        description1 = new JLabel("");
        description1.setFont(new Font("sansserif",1,30));
    ...
    protected void paintComponent(Graphics grphcs) {
        ...
        GradientPaint gra=new GradientPaint(0,0,new Color(11, 165, 182), 0,getHeight(),new Color(135, 229, 239));
        g2.setPaint(gra);
